...
abstract class Constant {
       companion object{
               val CHAPTERS_NAMES = listOf("الفاتحه","البقرة","آل عمران"
                       ...
                       ,"لقمان","السجدة","الأحزاب","سبأ"
                       ,"فاطر","يس","الصافات","ص","الزمر","غافر","فصّلت","الشورى","الزخرف"
                       ,"الدّخان","الجاثية","الأحقاف"
               ...
               val CHAPTERS_AYAT = listOf(7,286,200,176,120,165,206,75,129,109,123,111,43,52,99,128,
                       111,110,59,130,112,78,118,64,77,227,93,88,69,60,34,30,73,
                       ...
                       20,15,21,11,8,8,19,5,8,8,11,11,8,5,6,3,9,5,4,7,3,6,3,5,6)

               val FILE_NAME = "File_Name"
               val SURA_NAME = "Sura_Name"
               val AyatCount = "Ayat_Count"
       }
